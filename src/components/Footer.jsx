...
function Footer(){
    return(
        <footer className="font-['DM_Sans',sans-serif] bg-dark py-12 px-16 border-t border-white/5">
            <div className="flex justify-between items-center gap-6 flex-wrap">
                <div className="font-['Playfair_Display',serif] text-xl text-gold">La Vigroh</div>
                <div className="flex gap-8 flex-wrap">
                    <Link to="/#products" className="text-muted text-[0.8rem] no-underline tracking-wide hover:text-gold transition-colors">Products</Link>
                    <Link to="/about" className="text-muted text-[0.8rem] no-underline tracking-wide hover:text-gold transition-colors">About Us</Link>
                    <a href="#" className="text-muted text-[0.8rem] no-underline tracking-wide hover:text-gold transition-colors">Pricing</a>
                    ...
                    <Link to="/#contact" className="text-muted text-[0.8rem] no-underline tracking-wide hover:text-gold transition-colors">Contact</Link>
                </div>
            </div>
